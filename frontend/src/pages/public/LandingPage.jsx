...
export default function LandingPage() {
  ...
  /*
   * ============================================================
   * FITUR CARI MOBIL RENTAL
   * ============================================================
   * Fitur ini sengaja DINONAKTIFKAN, bukan dihapus.
   *
   * Jika ingin mengaktifkannya kembali:
   * 1. Uncomment useNavigate
   * 2. Uncomment Search dari lucide-react
   * 3. Uncomment searchCity dan searchQuery
   * 4. Uncomment handleSearchSubmit
   * 5. Uncomment kembali Search Card di bagian Hero
   * ============================================================
   */
  ...
  const handleSearchSubmit = (e) => {
    ...
    if (searchCity) {
      navigate(
        `/cars?city=${encodeURIComponent(searchCity)}&search=${encodeURIComponent(searchQuery)}`
      );
    } else {
      navigate(
        `/cars?search=${encodeURIComponent(searchQuery)}`
      );
    }
  };
  */
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setActiveRentals(
          rentalsRes?.data?.slice(0, 4) || []
        );

        setFeaturedCars(
          carsRes?.data?.slice(0, 6) || []
        );
      } catch (err) {
        console.error(
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-warm-200/90 text-sm sm:text-base leading-relaxed max-w-xl">
                Temukan dan sewa mobil terverifikasi dari mitra rental
                terpercaya di seluruh Indonesia. Pilihan armada prima,
                harga transparan, dan pemesanan instan tanpa repot.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10 max-w-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-warm-300/80 mt-0.5 font-medium">
                    Armada Mobil
                  </p>
                </div>
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold text-lime">
                    98%
                  </p>
                  <p className="text-xs text-warm-300/80 mt-0.5 font-medium">
                    Tingkat Kepuasan
            ...
            {/* =====================================================
                SEARCH CARD - DINONAKTIFKAN
                =====================================================

                FITUR INI TIDAK DIHAPUS.

                Untuk mengaktifkan kembali, hapus tanda komentar
                pada seluruh blok JSX di bawah ini.

            <div className="lg:col-span-5">
              <div className="bg-white rounded-3xl p-6 sm:p-7 shadow-floating border border-warm-200 text-ink-primary space-y-5">

                <div className="space-y-1">
                  <h3 className="text-lg font-extrabold text-ink-primary tracking-tight">
                    Cari Mobil Rental
                  </h3>

                  <p className="text-xs text-ink-secondary">
                    Pilih lokasi kota dan kata kunci kendaraan
                  </p>
                </div>
                ...
                <div className="pt-3 border-t border-warm-200 flex items-center justify-between text-[11px] text-ink-secondary font-medium">
                  ...
                  <span className="flex items-center gap-1">
                    <ShieldCheck className="h-3.5 w-3.5 text-midnight-900" />
                    Mitra Berizin
                  </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <div className="space-y-1">
              <span className="text-xs font-extrabold uppercase tracking-wider text-midnight-600">
                Pilihan Populer
              </span>

              <h2 className="text-2xl sm:text-3xl font-extrabold text-ink-primary tracking-tight">
                Armada Mobil Pilihan
              </h2>

              <p className="text-xs text-ink-secondary">
                Kendaraan prima siap jalan dengan ulasan terbaik dari pelanggan
              </p>
            </div>
                    ...
                    <div className="p-5 space-y-3">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="text-right shrink-0">
                          ...
                          <span className="text-[10px] text-ink-secondary font-medium block">
                            / hari
                          </span>
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-ink-secondary">
                Penyedia sewa resmi dengan izin usaha legalitas lengkap
              </p>
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-ink-secondary line-clamp-2 leading-relaxed">
                    {rental.description ||
                      'Penyedia layanan rental mobil terpercaya dengan armada berkualitas.'}
                  </p>
                ...
                <div className="pt-3 border-t border-warm-200 flex items-center justify-between text-xs">
                  ...
                  <RatingStars
                    ...
                    count={rental.totalReviews}
                  />

                  <span className="font-extrabold text-midnight-900">
                    {rental.totalCars} Mobil
                  </span>
        ...
        <section className="bg-midnight-900 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-card">
          ...
          <div className="max-w-xl space-y-4 relative z-10">
            ...
            <p className="text-xs sm:text-sm text-warm-200/80 leading-relaxed">
              Daftarkan tempat rental Anda, jangkau ribuan pelanggan baru,
              dan kelola seluruh jadwal sewa serta armada dengan sistem
