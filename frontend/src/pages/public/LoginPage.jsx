...
export default function LoginPage() {
  ...
  // ============================================================
  // DEMO ACCOUNT
  // Hanya User dan Partner.
  // ADMIN TIDAK DISEDIAKAN AUTO-FILL.
  // ============================================================
  ...
  return (
    <div className="min-h-[calc(100vh-12rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6">
        ...
        {/* ======================================================
            DEMO ACCOUNTS
            Admin sengaja tidak ditampilkan.
        ====================================================== */}
        ...
        <form
          ...
          className="bg-slate-950 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4"
        >
