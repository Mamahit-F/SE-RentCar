@echo off
set "PG_BIN=d:\from c\Documents\holyyy\SoftwareEngineering\pgsql\pgsql\bin"
set "PG_DATA=d:\from c\Documents\holyyy\SoftwareEngineering\pgsql\pgsql\data"
set PGPASSWORD=postgres

if not exist "%PG_DATA%\PG_VERSION" (
    echo [1/3] Initializing PostgreSQL cluster in %PG_DATA%...
